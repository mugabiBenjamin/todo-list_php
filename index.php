...
include_once './tasks/validation.php';
include_once './tasks/fetch.php';
...
<body>
    ...
    <div class="container-md">
        ...
        <form action="./tasks/add.php" method="POST">
            ...
            <input type="text" name="name" maxlength="50" placeholder="Add your task here..."
        ...
        <ul>
            ...
            <li>
                <a href="./tasks/toggle.php?id=<?php echo $task['id']; ?>&csrf_token=<?php echo $_SESSION['csrf_token']; ?>"
                    class="task-toggle">
                    ...
                    <div class="task">
                        ...
                        <div class="delete-icon">
                            <a
                                href="./tasks/delete.php?id=<?php echo $task['id']; ?>&csrf_token=<?php echo $_SESSION['csrf_token']; ?>">
